  ...
  return (
    <div className="mt-12">
      <div className="flex flex-wrap lg:flex-nowrap justify-center">
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-72 rounded-xl w-full lg:w-100 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center">
          <div className="flex justify-between items-center">
            <div>
              <p className="font-bold text-white">Earnings</p>
              <p className="text-2xl text-white">₹1,63,448</p>
            </div>
          </div>
          <div className="mt-6">
            <Button
          ...
          <div className='mt-10 flex gap-10 flex-wrap justify-center'>
            <div className="flex items-center">
              <div className="border-r-1 border-color m-4 pr-10">
                <div>
                  <p>
                    <span className='text-3xl font-semibold'>₹1,89,560</span>
                ...
                <div className="mt-8">
                  <p>
                    <span className='text-3xl font-semibold'>₹23,112</span>
                  </p>
